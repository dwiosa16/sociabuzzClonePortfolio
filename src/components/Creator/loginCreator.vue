...
const handleGoogleLogin = () => {
  alert('Menghubungkan ke API Google Auth untuk Kreator...');
};

const handleManualLogin = () => {
  alert(`Login Kreator dikirim! Email: ${email.value}`);
  // Disini nanti tempatnya axios.post('/api/login/creator, {email: email.value, password: password.value} ')
};
</script>
